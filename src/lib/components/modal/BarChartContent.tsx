...
// const defaultChartData: ChartData<"bar", (number | [number, number] | null)[], unknown> = {
//   labels: [],
//   datasets: [],
// };
      ...
      >
        ...
        >
          {loading ? (
            ...
            <BarChartColor
              chartData={chartData as ChartData<"bar">}
              setChartData={setChartData as (data: ChartData<"bar">) => void}
